...
int c_callback_function(int ID, int ID2)
{
    return cplusplus_callback_function(ID, ID2);
}
int c_callback_publish(int* Tour, int Dim, GainType Cost)
{
    return cplusplus_callback_publish(Tour, Dim, Cost);
}
